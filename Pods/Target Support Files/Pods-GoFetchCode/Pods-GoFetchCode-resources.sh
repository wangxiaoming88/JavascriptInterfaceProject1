...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "Mixpanel/Mixpanel/Media.xcassets/MPCloseBtn.imageset/MPCloseBtnIpad.png"
  install_resource "Mixpanel/Mixpanel/Media.xcassets/MPCloseBtn.imageset/MPCloseBtnIpad@2x.png"
  install_resource "Mixpanel/Mixpanel/Media.xcassets/MPCloseBtn.imageset/MPCloseBtnIpad@3x.png"
