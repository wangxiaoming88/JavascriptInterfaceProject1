//
//  BookmarkSectionViewController.m
//  GoFetchCoder
//
...
@interface BookmarkSectionViewController () <UIWebViewDelegate>{
...
@implementation BookmarkSectionViewController
...
- (void)setFooterButton:(UIButton *) btn NSString: text{
    ...
    if ([text isEqualToString:@"Bookmark"]) {
        [btn setImage:[UIImage imageNamed:@"i_bookmarked"] forState:UIControlStateNormal];
...
- (void)webViewDidFinishLoad:(UIWebView *)webView{
    ...
    webView.alpha = 1.0;
    int scrollTop = [webView setBookmark:[_sectionSequenceTitle intValue] end:[_sectionSequenceTitle intValue]+500];
    webView.scrollView.contentOffset = CGPointMake(0, scrollTop);
}
